...
def rotate_and_flip_images(cropped_image, base_filename, augmented_dir, crop_index):
    # Save the original cropped image with unique name
...
def main():
    image_dir = r'C:\Users\XiaQi\Documents\Bristol\Individual_Project\Agglutination Pictures'
    augmented_dir = 'C:/Users/XiaQi/Documents/Bristol/Individual_Project/OneDrive_2024-01-30/Augmented_Images9'
    crop_size = 400  # Desired crop size
    num_crops = 12  # Number of crops per image
